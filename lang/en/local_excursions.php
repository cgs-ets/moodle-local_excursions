...
$string['activityform:notes'] = 'Details <br><small>Information displayed here will flow through to the staff and public calendars, please include a brief description, who is attending or is required to attend</small>';
...
$string['status:inreview'] = 'Pending - {$a}';
...
$string['covidcampsterms'] = '<p class="alert-info p-4"><strong>For Residential Excursions or Camps (upon submission of this form)</strong><br>I agree that I will undertake to RAT test my child the night before they attend Camp and upload all results; negative, positive, or that your child is within the 28 days post COVID non-testing period, via CGS Connect “<a style="text-decoration: underline;" href="https://infiniti.canberragrammar.org.au/Infiniti/Produce/launch.aspx?id=3141be68-426c-4e6b-bb2b-4912e02a113a&portal=1" target="_blank">Report Absence</a>” portal.  I also agree that should my child present signs/symptoms the day of Camp, they will remain home.  I consent to the School/Camp Providers administering a RAT test to my child if they develop signs/symptoms whilst on camp and agree to collect my child from Camp should they test positive.</p>';