...
class form_event extends \moodleform {
    ...
    function definition() {
        ...
        *----------------------*/
        ...
        $mform->addGroup($radioarray, 'activitytype', "Type", array(' '), false);
        ...
        *----------------------*/
        ...
        $mform->addElement('html', '<div class="entry-type-heading"><br><strong>What type of entry is this?</strong></div>');
